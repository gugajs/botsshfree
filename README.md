...
```wget https://raw.githubusercontent.com/gugajs/botsshfree/main/iniciar.sh -O iniciar.sh; chmod +x iniciar.sh; ./iniciar.sh```


Com esse script você terá um bot de contas SSH PRE PAGO e funçional.
